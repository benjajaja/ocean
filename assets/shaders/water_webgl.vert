...
layout(std140) uniform WaterMaterial_wave1 {
    vec4 wave1;
};
layout(std140) uniform WaterMaterial_wave2 {
    vec4 wave2;
};
layout(std140) uniform WaterMaterial_wave3 {
    vec4 wave3;
};
